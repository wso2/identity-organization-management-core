...
public class OrganizationManagementConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_ERROR_CHECKING_IS_ANCESTOR_ORGANIZATION("65150", "Unable to check if ancestor " +
                "organization check.", "Server encountered an error while checking if organizations %s " +
                "is an ancestor organization of organizations %s");

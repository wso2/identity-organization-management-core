...
public class SQLConstants {
    ...
    public static final String USER_NAME_LIST_PLACEHOLDER = "_USER_NAMES_";
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ASSOCIATIONS = "SELECT UM_ORG.UM_ID, UM_ORG.UM_ORG_NAME, " +
            "UM_ORG.UM_CREATED_TIME, UM_ORG.UM_STATUS FROM UM_ORG INNER JOIN UM_ORG_USER_ASSOCIATION " +
            "ON UM_ORG.UM_ID = UM_ORG_USER_ASSOCIATION.UM_ORG_ID WHERE ";

    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS =
            "SELECT UM_ORG.UM_ID, UM_ORG.UM_ORG_NAME, UM_ORG.UM_CREATED_TIME, UM_ORG.UM_STATUS FROM " +
                    "UM_ORG_USER_ASSOCIATION INNER JOIN UM_ORG ON UM_ORG.UM_ID = UM_ORG_USER_ASSOCIATION.UM_ORG_ID " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ASSOCIATIONS_TAIL =
            ...
            "; AND UM_ORG.UM_ID IN (SELECT O.UM_ID FROM UM_ORG O JOIN " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS_TAIL =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
                    "; AND UM_HYBRID_USER_ROLE.UM_USER_NAME IN (" + USER_NAME_LIST_PLACEHOLDER + ") AND " +
                    "UM_DOMAIN.UM_DOMAIN_NAME = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_DOMAIN +
                    ...
                    "UM_HYBRID_ROLE_AUDIENCE.UM_AUDIENCE_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_AUDIENCE_ID +
                    ";) AND UM_ORG.UM_ID IN ( SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON " +
                    "O.UM_ID = OH.UM_ID WHERE OH.UM_PARENT_ID = ( SELECT UM_ID FROM UM_ORG WHERE %s) AND " +
                    "OH.DEPTH %s) ORDER BY UM_ORG.UM_CREATED_TIME %s LIMIT :" + SQLPlaceholders.DB_SCHEMA_LIMIT + ";";

    public static final String GET_ORGANIZATIONS_TAIL = "UM_ORG.UM_ID IN " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ASSOCIATIONS_TAIL_ORACLE =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
            "; AND UM_ORG.UM_ID IN (SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON O.UM_ID = OH.UM_ID " +
            "WHERE OH.UM_PARENT_ID = (SELECT UM_ID FROM UM_ORG WHERE %s) " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS_TAIL_ORACLE =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
                    ...
                    ";) AND UM_ORG.UM_ID IN ( SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON " +
                    "O.UM_ID = OH.UM_ID WHERE OH.UM_PARENT_ID = ( SELECT UM_ID FROM UM_ORG WHERE %s) AND " +
                    "OH.DEPTH %s) ORDER BY UM_ORG.UM_CREATED_TIME %s FETCH FIRST :" + SQLPlaceholders.DB_SCHEMA_LIMIT +
                    "; ROWS ONLY";

    public static final String GET_ORGANIZATIONS_TAIL_ORACLE = "UM_ORG.UM_ID IN " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ASSOCIATIONS_TAIL_MSSQL =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
            "; AND UM_ORG.UM_ID IN (SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON O.UM_ID = OH.UM_ID " +
            "WHERE OH.UM_PARENT_ID = (SELECT UM_ID FROM UM_ORG WHERE %s) " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS_TAIL_MSSQL =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
                    ...
                    ";) AND UM_ORG.UM_ID IN ( SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON " +
                    "O.UM_ID = OH.UM_ID WHERE OH.UM_PARENT_ID = ( SELECT UM_ID FROM UM_ORG WHERE %s) AND " +
                    "OH.DEPTH %s) ORDER BY UM_ORG.UM_CREATED_TIME %s OFFSET 0 ROWS FETCH NEXT :" +
                    SQLPlaceholders.DB_SCHEMA_LIMIT + "; ROWS ONLY";

    public static final String GET_ORGANIZATIONS_TAIL_MSSQL = "UM_ORG.UM_ID IN " +
            "(SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON O.UM_ID = OH.UM_ID WHERE OH.UM_PARENT_ID = " +
    ...
    public static final String GET_ORGANIZATION_DEPTH_IN_HIERARCHY_MSSQL = "SELECT TOP 1 DEPTH FROM UM_ORG_HIERARCHY " +
            "WHERE UM_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + "; ORDER BY DEPTH DESC";

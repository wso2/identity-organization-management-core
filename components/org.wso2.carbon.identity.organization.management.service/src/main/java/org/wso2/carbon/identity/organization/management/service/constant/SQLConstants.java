...
public class SQLConstants {
    ...
    public static final String GET_ORGANIZATION_DEPTH_IN_HIERARCHY_ORACLE = "SELECT DEPTH FROM UM_ORG_HIERARCHY WHERE " +
            "UM_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + "; ORDER BY DEPTH DESC FETCH FIRST 1 ROW ONLY";

    public static final String GET_ORGANIZATION_DEPTH_IN_HIERARCHY_MSSQL = "SELECT TOP 1 DEPTH FROM UM_ORG_HIERARCHY WHERE " +
            "UM_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + "; ORDER BY DEPTH DESC";

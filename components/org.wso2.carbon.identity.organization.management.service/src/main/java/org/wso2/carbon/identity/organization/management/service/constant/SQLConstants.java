...
public class SQLConstants {
    ...
    public static final String GET_AUTHORIZED_ORGANIZATIONS = "SELECT DISTINCT UM_ORG.UM_ID, UM_ORG.UM_ORG_NAME, " +
    ...
    public static final String GET_DISTINCT_ORGANIZATIONS = "SELECT DISTINCT UM_ORG.UM_ID, UM_ORG.UM_ORG_NAME, " +
            "UM_ORG.UM_CREATED_TIME, UM_ORG.UM_STATUS FROM UM_ORG WHERE ";

...
public class SQLConstants {
    ...
    public static final String GET_MINIMAL_ORG_DETAILS_BY_ORG_ID = "SELECT U.UM_ID, U.UM_ORG_NAME, U.UM_STATUS, " +
            "U.UM_CREATED_TIME, T.UM_DOMAIN_NAME, (SELECT H.DEPTH FROM UM_ORG_HIERARCHY H WHERE H.UM_ID = U.UM_ID " +
            "ORDER BY H.DEPTH DESC LIMIT 1) AS DEPTH FROM UM_ORG U JOIN UM_TENANT T ON " +
    ...
    public static final String GET_MINIMAL_ORG_DETAILS_BY_ORG_ID_ORACLE = "SELECT U.UM_ID, U.UM_ORG_NAME, " +
            "U.UM_STATUS, U.UM_CREATED_TIME, T.UM_DOMAIN_NAME, (SELECT H.DEPTH FROM UM_ORG_HIERARCHY H " +
            "WHERE H.UM_ID = U.UM_ID ORDER BY H.DEPTH DESC FETCH FIRST 1 ROWS ONLY) AS DEPTH FROM UM_ORG U " +
            "JOIN UM_TENANT T ON U.UM_ID = T.UM_ORG_UUID WHERE U.UM_ID = :" +
            SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + ";";

    public static final String GET_MINIMAL_ORG_DETAILS_BY_ORG_ID_MSSQL = "SELECT U.UM_ID, U.UM_ORG_NAME, " +
            "U.UM_STATUS, U.UM_CREATED_TIME, T.UM_DOMAIN_NAME, (SELECT TOP 1 H.DEPTH FROM UM_ORG_HIERARCHY H WHERE " +
            "H.UM_ID = U.UM_ID ORDER BY H.DEPTH DESC) AS DEPTH FROM UM_ORG U JOIN UM_TENANT T ON " +
            "U.UM_ID = T.UM_ORG_UUID WHERE U.UM_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + ";";

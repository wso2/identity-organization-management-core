...
public class SQLConstants {
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS =
            "SELECT UM_ORG.UM_ID, UM_ORG.UM_ORG_NAME, UM_ORG.UM_CREATED_TIME, UM_ORG.UM_STATUS FROM " +
                    ...
                    "INNER JOIN UM_USER ON UM_USER.UM_USER_NAME = UM_HYBRID_USER_ROLE.UM_USER_NAME " +
    ...
    public static final String GET_ORGANIZATIONS_WITH_USER_ROLE_ASSOCIATIONS_TAIL =
            "UM_ORG_USER_ASSOCIATION.UM_ASSOCIATED_USER_ID = :" + SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_USER_ID +
                    "; AND UM_USER.UM_TENANT_ID = UM_HYBRID_USER_ROLE.UM_TENANT_ID AND " +
                    "UM_ORG_USER_ASSOCIATION.UM_USER_ID = UM_USER.UM_USER_ID AND UM_SHARED_ROLE.UM_MAIN_ROLE_ID IN " +

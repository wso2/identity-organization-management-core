...
public class SQLConstants {
    ...
    public static final String GET_ORGANIZATIONS_TAIL_ORACLE_WITH_ALL_SUB_ORGS = "UM_ORG.UM_ID IN " +
    ...
    public static final String GET_ORGANIZATIONS_TAIL_MSSQL_WITH_ALL_SUB_ORGS = "UM_ORG.UM_ID IN " +
            "(SELECT O.UM_ID FROM UM_ORG O JOIN UM_ORG_HIERARCHY OH ON O.UM_ID = OH.UM_ID WHERE OH.UM_PARENT_ID = " +
